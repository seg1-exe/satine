        ...
        '<div id="player-bar">' +
          '<div class="kw-screen">' +
            ...
            '<div id="kw-progress" title="Avancer / reculer dans le morceau">' +
              ...
              '<img class="kw-thumb" id="kw-thumb" src="' + ASSET('seek-thumb.gif') + '" alt="">' +
            '</div>' +
          '</div>' +
          '<img class="kw-body" src="' + ASSET('body.png') + '" alt="Player Kenwood MP7">' +
          '<img class="kw-strip" src="' + ASSET('left-set-default.jpg') + '" style="left:23px;top:22px" alt="">' +
          '<img class="kw-strip" src="' + ASSET('right-set-default.jpg') + '" style="left:418px;top:22px" alt="">' +
          '<img class="kw-strip" src="' + ASSET('main-set1-default.jpg') + '" style="left:76px;top:111px" alt="">' +
          '<img class="kw-strip" src="' + ASSET('main-set2-default.jpg') + '" style="left:293px;top:111px" alt="">' +
