...
(function () {
  ...
  /* PRIORITÉS : `pin: 'bottom'` épingle en bas d'un rail — une pub épinglée
     ...
     Liens : `href` (ancre — depuis /pages/secret on repasse par index.html,
  ...
  (function () {
    var prefix = document.body.getAttribute('data-page') === 'secret' ? '/' : '';
    var ADS = [
      { img: '' + ASSET('rendu360.webp') + '', w: 480, h: 640, alt: 'La barrette SATINE sous toutes les coutures', modal: 'barrettes' },
      { img: '' + ASSET('pub-satine.mp4') + '', poster: '' + ASSET('poster-pub-satine.webp') + '', w: 380, h: 1658, pin: 'bottom', alt: 'Publicité SATINE' },
      { img: '' + ASSET('pub-tour.mp4') + '', poster: '' + ASSET('poster-pub-tour.webp') + '', w: 660, h: 990, alt: 'European Tour — voir les dates', href: prefix + '#tournee', title: 'Toutes les dates de la tournée' },
      { img: '' + ASSET('satine5.mp4') + '', poster: '' + ASSET('poster-satine5.webp') + '', w: 560, h: 752, alt: 'SHOP ! Les barrettes SATINE, édition limitée — 25€', modal: 'barrettes' },
      { img: '' + ASSET('satine-9.mp4') + '', poster: '' + ASSET('poster-satine-9.webp') + '', w: 660, h: 880, alt: 'Poster SATINE à vendre — 10€', modal: 'poster' },
      { img: '' + ASSET('pubschats.mp4') + '', poster: '' + ASSET('poster-pubschats.webp') + '', w: 660, h: 496, alt: 'Les barrettes SATINE, approuvées par les chats — 25€', modal: 'barrettes' },
      { img: '' + ASSET('satine2.mp4') + '', poster: '' + ASSET('poster-satine2.webp') + '', w: 660, h: 1496, alt: 'CALL NOW — SATINE limited edition, explore all items', href: prefix + '#merch', title: 'Voir le merch' },
      { img: '' + ASSET('satine-10.mp4') + '', poster: '' + ASSET('poster-satine-10.webp') + '', w: 660, h: 1174, alt: 'ANOMALISA — les barrettes SATINE', modal: 'barrettes' },
      { img: '' + ASSET('satine-3-2.mp4') + '', poster: '' + ASSET('poster-satine-3-2.webp') + '', w: 660, h: 1174, alt: 'satine — press PLAY', href: prefix + '#clip', title: 'Voir le clip' },
      { img: '' + ASSET('satine-windows.mp4') + '', poster: '' + ASSET('poster-satine-windows.webp') + '', w: 660, h: 772, alt: 'Poster SATINE — 10€', modal: 'poster' },
      { img: '' + ASSET('paintsatine2.mp4') + '', poster: '' + ASSET('poster-paintsatine2.webp') + '', w: 660, h: 984, alt: 'MF NPU EF QBTTF FTU: EFLPOOFDUF' }
    ];
