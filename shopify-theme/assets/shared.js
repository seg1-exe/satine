...
(function () {
  ...
  /* Les vraies pubs prennent des emplacements AU HASARD (et distincts) à
     ...
     au repos). Liens : `href` (ancre — depuis /pages/secret on repasse par
  ...
  (function () {
    ...
    var ADS = [
      { img: '' + ASSET('rendu360.webp') + '', w: 480, h: 640, pin: 'top', alt: 'La barrette SATINE sous toutes les coutures', modal: 'barrettes' },
      { img: '' + ASSET('pub-poster.webp') + '', w: 660, h: 758, pin: 'top', alt: 'Do you love my post-internet poster ?', modal: 'poster' },
      { img: '' + ASSET('pub-satine.mp4') + '', w: 380, h: 1658, pin: 'bottom', alt: 'Publicité SATINE' },
      { img: '' + ASSET('pub-tour.mp4') + '', w: 660, h: 990, alt: 'European Tour — voir les dates', href: prefix + '#tournee', title: 'Toutes les dates de la tournée' },
      { img: '' + ASSET('full-barette.webp') + '', w: 660, h: 1497, alt: 'Barrettes SATINE — call now', modal: 'barrettes' },
      { img: '' + ASSET('pub-barettes.webp') + '', w: 660, h: 880, alt: 'Shop — les barrettes SATINE', modal: 'barrettes' },
      { img: '' + ASSET('satine-cat.webp') + '', w: 660, h: 496, alt: 'Les barrettes SATINE, approuvées par les chats', modal: 'barrettes' },
      { img: '' + ASSET('alien-fashion.webp') + '', w: 660, h: 880, alt: 'Alien fashion ? — le merch SATINE', href: prefix + '#merch', title: 'Voir le merch' },
      { img: '' + ASSET('pub-password.webp') + '', w: 660, h: 660, alt: 'MF NPU EF QBTTF FTU: EFLPOOFDUF' }
    ];
